...
class ContractService:
    ...
    # 闪电平仓
    def contract_lightning_close_position(self,symbol=None, contract_type=None, contract_code=None,client_order_id=None,volume=None,direction=None,order_price_type=None,channel_code=None):
