...
class ContractService:
    ...
    # 获取账户总资产估值
    def contract_balance_valuation(self, valuation_asset=None):
        """
        参数名称           参数类型            必填      描述
        ...
        request_path = '/api/v1/contract_balance_valuation'
        return api_key_post(self.__url, request_path, params, self.__access_key, self.__secret_key)
    ...
    # 闪电平仓
    def contract_lightning_close_position(self, symbol=None, contract_type=None, contract_code=None,
                                          client_order_id=None, volume=None, direction=None, order_price_type=None,
                                          channel_code=None):
...
t = ContractService(URL, ACCESS_KEY, SECRET_KEY)
