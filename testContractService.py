...
# pprint(ct.contract_balance_valuation())
# pprint(ct.contract_balance_valuation(valuation_asset='BTC'))
# pprint(ct.contract_balance_valuation(valuation_asset='USD'))
# pprint(ct.contract_balance_valuation(valuation_asset='CNY'))
# pprint(ct.contract_balance_valuation(valuation_asset='EUR'))
# pprint(ct.contract_balance_valuation(valuation_asset='GBP'))
# pprint(ct.contract_balance_valuation(valuation_asset='VND'))
# pprint(ct.contract_balance_valuation(valuation_asset='HKD'))
# pprint(ct.contract_balance_valuation(valuation_asset='TWD'))
# pprint(ct.contract_balance_valuation(valuation_asset='MYR'))
# pprint(ct.contract_balance_valuation(valuation_asset='SGD'))
# pprint(ct.contract_balance_valuation(valuation_asset='KRW'))
# pprint(ct.contract_balance_valuation(valuation_asset='RUB'))
# pprint(ct.contract_balance_valuation(valuation_asset='TRY'))
...
# pprint(ct.contract_sub_auth(sub_uid=SUBID, sub_auth=1))
# pprint(ct.contract_sub_auth(sub_uid=SUBID, sub_auth=1))
...
# pprint(ct.contract_sub_account_info(sub_uid=SUBID))
# pprint(ct.contract_sub_position_info(sub_uid=SUBID))
...
#
# pprint(ct.contract_master_sub_transfer(sub_uid=SUBID, symbol='BTC', amount='1008', type='master_to_sub'))
...
#
# pprint('order--------------------------------------------------------')
# pprint(ct.contract_order(symbol='BTC', contract_type='this_week', volume='1', direction='buy', offset='open',
#                          lever_rate='10',
...
#     }]
# }))
# pprint(ct.contract_order(symbol='TRX', contract_type='this_week', volume='1', direction='sell', offset='open',
#                          lever_rate='10',
#                          order_price_type='limit', price='0.07035'))  #958767929133588480
# pprint(ct.contract_batchorder({
#     "orders_data": [{
#         "symbol": 'TRX',
#         "contract_type": 'this_week',
...
# pprint(ct.contract_hisorders(symbol='BTC', trade_type='0', type='1', status='0,5,6,7', create_date='90'))
# pprint(ct.contract_hisorders_exact(symbol='BTC', trade_type='0', type='1', status='0,5,6,7'))
...
# pprint(ct.contract_lightning_close_position(symbol='BTC',contract_type='this_week', volume='1', direction='6'))
# pprint(ct.contract_lightning_close_position(symbol='TRX', contract_type='this_week', volume='1', direction='buy'))
# pprint(ct.contract_trigger_order(symbol='BTC', contract_type='this_week', trigger_type='ge', trigger_price='1', order_price='1001',
...
# pprint(ct.contract_tpsl_order(symbol='TRX', contract_type='this_week', volume='1', direction='buy',tp_trigger_price='0.71',tp_order_price= '0.71'))
...
# pprint(ct.contract_track_order(symbol='BTC',  contract_type='this_week',callback_rate='0.01', active_price='1',
...
# pprint(ct.contract_bbo(symbol='BTC_CW'))
# pprint(ct.contract_bbo(symbol='BTC_NW'))
# pprint(ct.contract_bbo(symbol='BTC_CQ'))
# pprint(ct.contract_bbo(symbol='BTC_NQ'))
...
# pprint(ct.contract_batch_merged(symbol='BTC_CW'))
# pprint(ct.contract_batch_merged(symbol='BTC_NW'))
# pprint(ct.contract_batch_merged(symbol='BTC_CQ'))
# pprint(ct.contract_batch_merged(symbol='BTC_NQ'))
...
# pprint(ct.contract_mark_price_kline(symbol='BTC_CW', period='30min', size=20))
# pprint(ct.contract_basis(symbol='BTC_CW', period='1day', size='10'))
